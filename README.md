...
6 | Post User	                              | localhost:8080/users	                           | POST /users	                                    | {} |
7 | Delete User	                            | localhost:8080/users/:id	                       | DELETE /users/6	                                | null               |
8 | Patch User	                            | localhost:8080/users/:id                         | PATCH /users/7	                                  | {}   |
...
3 | Delete Review                           | localhost:8080/reviews/:id         | DELETE /reviews/1                                | null               |
